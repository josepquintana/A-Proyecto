...
public:
     ...
     * @param U         Union que s'está construint.
     * @param visited   vector indicant quins vèrtexs estan ja visitats.
     * @param id        id del vèrtex que s'está visitant actualment.
     */
    void recToU(QuickUnionUF &qU, vector<bool> &visited, int id);

    /**
     * Tranforma el graph a Union.
     * @return  Graph convertit a Union.
     */
    Union toUnion();

    /**
     * Indica si el Graph és connex.
     * @return  true si el Graph és connex, false altrament.
     */
    bool esConnex();
